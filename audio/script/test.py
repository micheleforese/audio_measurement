...
def phase_analysis():
    ...
    with InterruptHandler() as h:
        ...
        for frequency in track(
            ...
            # plt.plot(voltages_sampling_0.voltages)
            # plt.plot(voltages_sampling_1.voltages)
            # plt.show()
            # plt.close()

            # diff_volts = voltages_sampling_0.voltages - voltages_sampling_1.voltages
            # plt.plot(diff_volts)
            # plt.title(f"{frequency:.5f}")
            # plt.show()
            # plt.close()
            ...
            # plt.plot(voltages_sampling_0.voltages)
            # plt.plot(voltages_sampling_1.voltages)
            # plt.savefig(APP_TEST / f"{frequency:.5f}.png")
            # plt.close()
